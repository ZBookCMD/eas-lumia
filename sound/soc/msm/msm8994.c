...
static struct snd_soc_dai_link msm8994_common_dai_links[] = {
	/* FrontEnd DAI Link (Вход от системы Android) */
	{
		.name = "MSM8994 Media1",
	...
	/* BackEnd DAI Link (Выход на наш чип TAS2552) */
	{
...
static int msm8994_asoc_machine_probe(struct platform_device *pdev)
{
	...
	pr_err("================ Minimal System Group ==================");
	pr_err("====== STARTING NEW MSM8994 WITH TAS2552 SUPPORT ======");
	pr_err("========================================================");
